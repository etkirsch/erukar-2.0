...
describe ('basic tests', () => {
  it('renders completed campaign  without crashing', () => {
    const div = document.createElement('div');
    ReactDOM.render(<Router><CampaignOverview campaign={completedCampaign} /></Router>, div);
    ReactDOM.unmountComponentAtNode(div);
  })

  it('renders uncompleted campaign  without crashing', () => {
    const div = document.createElement('div');
    ReactDOM.render(<Router><CampaignOverview campaign={uncompletedCampaign} /></Router>, div);
    ReactDOM.unmountComponentAtNode(div);
  })
})
